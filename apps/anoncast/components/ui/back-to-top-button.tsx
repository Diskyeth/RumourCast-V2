...
<button
  onClick={scrollToTop}
  className="fixed bottom-6 right-6 z-10 w-14 h-14 flex items-center justify-center !bg-black/80 backdrop-blur-md text-white rounded-full shadow-xl transition-transform duration-300 hover:scale-105 gradient-border-wrapper"
