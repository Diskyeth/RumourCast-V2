...
const colorTokens = {
  light: {
    ...
    indigo,
    iris: {
      iris1: 'hsl(240, 100%, 99.6%)',
      iris2: 'hsl(240, 100%, 98.6%)',
      iris3: 'hsl(236, 87.5%, 96.9%)',
      iris4: 'hsl(238, 100%, 95.1%)',
      iris5: 'hsl(237, 100%, 92.7%)',
      iris6: 'hsl(238, 100%, 89.8%)',
      iris7: 'hsl(238, 82.1%, 84.7%)',
      iris8: 'hsl(238, 73.9%, 77.5%)',
      iris9: 'hsl(240, 60%, 59.8%)',
      iris10: 'hsl(240, 55.4%, 56.1%)',
      iris11: 'hsl(242, 50.2%, 55.1%)',
      iris12: 'hsl(238, 43.1%, 26.9%)',
    },
  },
  dark: {
    blue: blueDark,
    ...
    indigo: indigoDark,
    iris: {
      iris1: 'hsl(240, 22.4%, 9.6%)',
      iris2: 'hsl(244, 25.4%, 11.6%)',
      iris3: 'hsl(237, 38.5%, 20.4%)',
      iris4: 'hsl(236, 45.3%, 27.3%)',
      iris5: 'hsl(237, 41.5%, 32.2%)',
      iris6: 'hsl(239, 36.1%, 37.5%)',
      iris7: 'hsl(240, 33.6%, 43.7%)',
      iris8: 'hsl(241, 36.3%, 52%)',
      iris9: 'hsl(240, 60%, 59.8%)',
      iris10: 'hsl(242, 63.7%, 64.3%)',
      iris11: 'hsl(246, 100%, 83.1%)',
      iris12: 'hsl(242, 93.9%, 93.5%)',
    },
  },
}
...
const darkColors = {
  ...
  ...colorTokens.dark.plum,
  ...colorTokens.dark.indigo,
  ...colorTokens.dark.iris,
}

const lightColors = {
  ...colorTokens.light.blue,
  ...colorTokens.light.mauve,
  ...
  ...colorTokens.light.plum,
  ...colorTokens.light.indigo,
  ...colorTokens.light.iris,
}
      ...
      (key, index) =>
        [
          ...
          getColorPalette(
            ...
            colorTokens.light[lightColorNames[(index + 1) % lightColorNames.length] || 0]
          ),
        ] as const
    )
  )
      ...
      (key, index) =>
        [
          ...
          getColorPalette(
            ...
            colorTokens.light[darkColorNames[(index + 1) % darkColorNames.length] || 0]
          ),
        ] as const
    )
  )
...
export const getTemplates = (scheme: 'dark' | 'light') => {
  ...
  const borderColorBg = isLight ? 'rgb(239, 243, 244)' : 'rgba(256, 256, 256, 0.1)'
